                ...
                <div class="col-sm-5">
                    <div class="user-area dropdown float-right">
                        <a href="#" class="dropdown-toggle" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                            <img class="user-avatar rounded-circle" src="<?php echo $this->session->userdata('avatar'); ?>" alt="user-<?php echo $this->session->userdata('iduser'); ?>" title="<?php echo $this->session->userdata('displayName'); ?>">
                        </a>

                        <div class="user-menu dropdown-menu">
                            <a class="nav-link" href="#"><i class="fa fa-user"></i> <?php echo $this->session->userdata('displayName'); ?></a>
