                    ...
                    <form action="<?php echo base_url();?>administration/permissions/store" method="post" enctype="multipart/form-data" class="form-horizontal">
                            ...
                            <div class="col-12 col-md-9">
                                <select name="selNavi" id="select" class="form-control">
                                    ...
                                    <?php foreach($navigations as $navi): ?>
                                        <option value="<?php echo $navi->NAVI_Code;?>"><?php echo $navi->NAVI_Name;?></option>
                                    <?php endforeach; ?>
                                </select>
                            </div>
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <label for="radio1" class="radio-inline">
                                <input type="radio" id="radio1" name="radioRead" value="1" class="form-check-input" checked="checked">Yes
                            </label>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                            <label for="radio1" class="radio-inline">
                                <input type="radio" id="radio1" name="radioRead" value="0" class="form-check-input">No
                            </label>
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <label for="radio2" class="radio-inline">
                                <input type="radio" id="radio2" name="radioInsert" value="1" class="form-check-input" checked="checked">Yes
                            </label>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                            <label for="radio2" class="radio-inline">
                                <input type="radio" id="radio2" name="radioInsert" value="0" class="form-check-input">No
                            </label>
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <label for="radio3" class="radio-inline">
                                <input type="radio" id="radio3" name="radioUpdate" value="1" class="form-check-input" checked="checked">Yes
                            </label>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                            <label for="radio1" class="radio-inline">
                                <input type="radio" id="radio3" name="radioUpdate" value="0" class="form-check-input">No
                            </label>
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <label for="radio4" class="radio-inline">
                                <input type="radio" id="radio4" name="radioDelete" value="1" class="form-check-input" checked="checked">Yes
                            </label>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                            <label for="radio4" class="radio-inline">
                                <input type="radio" id="radio4" name="radioDelete" value="0" class="form-check-input">No
                            </label>
                        </div>
